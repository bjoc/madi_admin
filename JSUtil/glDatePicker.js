	...
	var glDatePicker = (function() {
		...
		function glDatePicker(element, userOptions) {
			...
			el
				...
				.bind('focusout', function(e) {self.hide(e);});
		...
		glDatePicker.prototype =
		{
			show: function() {
				...
				this.calendar.css(
					{
						top: (this.el.offset().top + this.el.outerHeight() + this.options.calendarOffset.y) + 'px',
						left: (this.el.offset().left + this.options.calendarOffset.x) + 'px'
					});
			...
			render: function(renderCalback) {
				...
				var containerWidth = el.outerWidth() * 1.5;
